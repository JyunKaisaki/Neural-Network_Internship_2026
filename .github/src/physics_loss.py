...
def surface_potential_residual(
    ...
    # Evaluate the effective flat-band voltage with the externally supplied Qox.
    Vfbs_p = Vfbs_from_independent(Vfbs0, Cox, phis_PINN, Vds, Dit_mid, Dit_edge, sigma_it, Ec_minus_Ei, T_t, NA_t, Eg, Qox=Qox)
